	final_soc u0 (
		...
		.hero_data_export               (<connected-to-hero_data_export>),               //               hero_data.export
		...
		.map_write_map_write_enable     (<connected-to-map_write_map_write_enable>),     //               map_write.map_write_enable
		.map_write_map_write_data       (<connected-to-map_write_map_write_data>),       //                        .map_write_data
		.map_write_map_write_addr       (<connected-to-map_write_map_write_addr>),       //                        .map_write_addr
